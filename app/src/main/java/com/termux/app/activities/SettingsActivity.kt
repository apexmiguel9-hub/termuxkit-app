...
class SettingsActivity : AppCompatActivity() {
    ...
    class RootPreferencesFragment : PreferenceFragmentCompat() {
        ...
        private fun configureTermuxAPIPreference(@NonNull context: Context) {
        ...
        private fun configureTermuxFloatPreference(@NonNull context: Context) {
        ...
        private fun configureTermuxTaskerPreference(@NonNull context: Context) {
        ...
        private fun configureTermuxWidgetPreference(@NonNull context: Context) {
        ...
        private fun configureAboutPreference(@NonNull context: Context) {
        ...
        private fun configureDonatePreference(@NonNull context: Context) {
