...
/**
 * The [TermuxActivity] relies on `WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE`
 * set by [com.termux.app.terminal.TermuxTerminalViewClient.setSoftKeyboardState] to automatically
 ...
 * part of the candidates view returned by the keyboard app in `InputMethodService.onCreateCandidatesView()`.
 *
 ...
 */
open class TermuxActivityRootView : LinearLayout, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    override fun onGlobalLayout() {
        ...
        val bottomSpaceView = activity?.termuxActivityBottomSpaceView
        ...
        val windowAndViewRects = ViewUtils.getWindowAndViewRects(bottomSpaceView, statusBarHeight)
        ...
        // Else find the part of the extra keys/terminal that is hidden and add a margin accordingly
            ...
            val pxHidden = bottomSpaceViewRect.bottom - windowAvailableRect.bottom
    ...
    class WindowInsetsListener : OnApplyWindowInsetsListener {
        override fun onApplyWindowInsets(v: View, insets: WindowInsets): WindowInsets {
            statusBarHeight = WindowInsetsCompat.toWindowInsetsCompat(insets)
