...
object PermissionUtils {
     ...
     *
     * @param context The context for operations.
     * @param permissions The [String] names for permissions to check.
     ...
     * @param context The context for operations. It must be an instance of [Activity] or
     * [AppCompatActivity].
     * @param permissions The [String] names for permissions to request.
     ...
     */
    fun getPermissionsNotRequested(context: Context, permissions: Array<String>): java.util.List<String> {
        val permissionsNotRequested: MutableList<String> = ArrayList()
        ...
        if (packageInfo == null) {
            return ArrayList<String>(permissionsNotRequested) as List<String>
        }
