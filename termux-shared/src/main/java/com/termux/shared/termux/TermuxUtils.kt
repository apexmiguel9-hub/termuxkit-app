...
class TermuxUtils {
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun getTermuxPackageContext(@NonNull context: Context): Context? {
         ...
         */
        @JvmStatic
        fun getTermuxPackageContextWithCode(@NonNull context: Context): Context? {
         ...
         */
        @JvmStatic
        fun getTermuxAPIPackageContext(@NonNull context: Context): Context? {
         ...
         */
        @JvmStatic
        fun getTermuxBootPackageContext(@NonNull context: Context): Context? {
         ...
         */
        @JvmStatic
        fun getTermuxFloatPackageContext(@NonNull context: Context): Context? {
         ...
         */
        @JvmStatic
        fun getTermuxStylingPackageContext(@NonNull context: Context): Context? {
         ...
         */
        @JvmStatic
        fun getTermuxTaskerPackageContext(@NonNull context: Context): Context? {
         ...
         */
        @JvmStatic
        fun getTermuxWidgetPackageContext(@NonNull context: Context): Context? {
         ...
         */
        @JvmStatic
        fun isTermuxAppInstalled(@NonNull context: Context): String? {
         ...
         */
        @JvmStatic
        fun isTermuxAPIAppInstalled(@NonNull context: Context): String? {
         ...
         */
        @JvmStatic
        fun isTermuxAppAccessible(@NonNull currentPackageContext: Context): String? {
            ...
            if (errmsg == null) {
                ...
                if (errmsg == null) {
                    // If TERMUX_PREFIX_DIR_PATH is not a directory or does not have required permissions
            ...
            return if (errmsg != null) {
                "$errmsg ${currentPackageContext.getString(R.string.msg_termux_app_required_by_app, PackageUtils.getAppNameForPackage(currentPackageContext))}"
            } else {
                null
            }
        }
         ...
         */
        @JvmStatic
        fun getTermuxAppAPKBuildConfigClassField(@NonNull currentPackageContext: Context, @NonNull fieldName: String): Any? {
         ...
         */
        @JvmStatic
        fun getTermuxAppAPKClassField(@NonNull currentPackageContext: Context, @NonNull clazzName: String, @NonNull fieldName: String): Any? {
            return try {
                val termuxPackageContext = getTermuxPackageContextWithCode(currentPackageContext)
                if (termuxPackageContext == null)
                    return null
        ...
        @JvmStatic
        fun isUriDataForTermuxOrPluginPackage(@NonNull data: Uri): Boolean {
        ...
        @JvmStatic
        fun isUriDataForTermuxPluginPackage(@NonNull data: Uri): Boolean {
         ...
         */
        @JvmStatic
        fun sendTermuxOpenedBroadcast(@NonNull context: Context) {
            ...
            for (info in matches) {
                ...
                val cname = ComponentName(info.activityInfo.applicationInfo.packageName, info.activityInfo.name)
         ...
         *
         * Also check [PackageUtils.isAppInstalled] if targetting targeting
         * sdk `30` (android `11`) since `PackageManager.NameNotFoundException` may be thrown while
         * getting info of `callingPackageName` app.
         *
         * @param currentPackageContext The context of current package.
         * @param appInfoMode The [AppInfoMode] to decide the app info required.
        ...
        fun getAppInfoMarkdownString(currentPackageContext: Context, appInfoMode: AppInfoMode, @Nullable callingPackageName: String?): String? {
            ...
            when (appInfoMode) {
                AppInfoMode.TERMUX_PACKAGE -> return getAppInfoMarkdownString(currentPackageContext, false)

                AppInfoMode.TERMUX_AND_PLUGIN_PACKAGE -> return getAppInfoMarkdownString(currentPackageContext, true)
                ...
                AppInfoMode.TERMUX_PLUGIN_PACKAGES -> return getTermuxPluginAppsInfoMarkdownString(currentPackageContext)
                ...
                AppInfoMode.TERMUX_AND_CALLING_PACKAGE -> {
                    ...
                    if (!DataUtils.isNullOrEmpty(callingPackageName)) {
                        ...
                        val info: String = callingPackageAppInfo ?: ""
                        if (info.isNotEmpty()) {
                            val applicationInfo = PackageUtils.getApplicationInfoForPackage(currentPackageContext, callingPackageName ?: "")
                            if (applicationInfo != null) {
                                val appName = PackageUtils.getAppNameForPackage(currentPackageContext, applicationInfo) ?: ""
                                appInfo.append("\n\n## ").append(appName).append(" App Info\n")
                                appInfo.append(info)
                                appInfo.append("\n##\n")
                            }
                        }
        ...
        fun getAppInfoMarkdownStringInner(@NonNull context: Context): String {
            ...
            if (context.packageName == TermuxConstants.TERMUX_PACKAGE_NAME) {
                AndroidUtils.appendPropertyToMarkdown(markdownString, "TERMUX_APP_PACKAGE_MANAGER", TermuxBootstrap.TERMUX_APP_PACKAGE_MANAGER ?: "null")
                AndroidUtils.appendPropertyToMarkdown(markdownString, "TERMUX_APP_PACKAGE_VARIANT", TermuxBootstrap.TERMUX_APP_PACKAGE_VARIANT ?: "null")
            }
            ...
            if (signingCertificateSHA256Digest != null) {
                ...
                AndroidUtils.appendPropertyToMarkdown(markdownString, "APK_RELEASE_SIGNING_CERTIFICATE_SHA256_DIGEST", signingCertificateSHA256Digest)
            }
        ...
        fun geAPTInfoMarkdownString(@NonNull context: Context): String? {
            ...
            val inputStream: InputStream = context.resources.openRawResource(com.termux.shared.R.raw.apt_info_script)
            aptInfoScript = try {
            ...
            aptInfoScript = aptInfoScript.replace(Pattern.quote("@TERMUX_PREFIX@"), TermuxConstants.TERMUX_PREFIX_DIR_PATH)

            val executionCommand = ExecutionCommand(-1,
                TermuxConstants.TERMUX_BIN_PREFIX_DIR_PATH + "/bash", null, aptInfoScript,
                null, ExecutionCommand.Runner.APP_SHELL.name, false)
         ...
         */
        @JvmStatic
        fun getTermuxDebugMarkdownString(@NonNull context: Context): String? {
        ...
        fun getLogcatDumpMarkdownString(@NonNull context: Context): String? {
            ...
            val executionCommand = ExecutionCommand(-1, "/system/bin/sh",
                null, "$logcatScript\n", "/", ExecutionCommand.Runner.APP_SHELL.name, true)
