 ...
 *          Termux app and its plugins. This will allow `com.termux.app.TermuxSettings` to
...
object TermuxPreferenceConstants {
    ...
    object TERMUX_APP {
        ...
        /**
         * The [ExecutionCommand.Runner.APP_SHELL] number after termux app process since boot.
         */
        ...
        /**
         * The [ExecutionCommand.Runner.TERMINAL_SESSION] number after termux app process since boot.
         */
         ...
         */
        const val KEY_BACKGROUND_IMAGE_ENABLED = "background_image_enabled"
        const val DEFAULT_VALUE_BACKGROUND_IMAGE_ENABLED = false
    }
