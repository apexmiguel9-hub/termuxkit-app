...
object TermuxBootstrap {
    ...
    @JvmStatic
    fun setTermuxPackageManagerAndVariant(@Nullable packageVariantName: String?) {
        ...
        val packageVariantName: String = TERMUX_APP_PACKAGE_VARIANT?.name ?: ""
        val index: Int = packageVariantName.indexOf('-')
    ...
    enum class PackageManager(val displayName: String) {
        ...
        fun equalsManager(manager: String?): Boolean {
            return manager != null && manager == this.name
        }
    ...
    enum class PackageVariant(val displayName: String) {
        ...
        fun equalsVariant(variant: String?): Boolean {
            return variant != null && variant == this.name
        }
