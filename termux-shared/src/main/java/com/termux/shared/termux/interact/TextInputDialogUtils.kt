...
object TextInputDialogUtils {
     ...
     * @param titleText The title text resource id.
     * @param initialText The initial text to show in the input field.
     * @param positiveButtonText The positive button text resource id.
     * @param onPositive The callback to call when positive button is clicked.
     * @param neutralButtonText The neutral button text resource id. If 0, no neutral button is shown.
     * @param onNeutral The callback to call when neutral button is clicked.
     * @param negativeButtonText The negative button text resource id. If 0, cancel button is shown.
     * @param onNegative The callback to call when negative button is clicked.
     * @param onDismiss The callback to call when dialog is dismissed.
     */
    fun textInput(
        activity: Activity,
        titleText: Int,
