...
object TermuxPropertyConstants {
    ...
    /** Defines the key for whether the [TermuxAmSocketServer] should be run at app startup */
    ...
    @Deprecated(message = "Use KEY_NIGHT_MODE instead")
    ...
    //public const val DEFAULT_IVALUE_EXTRA_KEYS = "[[ESC, TAB, CTRL, ALT, {key: '-', popup: '|'}, DOWN, UP]]" // Single row
    ...
    val KEY_NIGHT_MODE = "night-mode" // Default: "night-mode"

    val IVALUE_NIGHT_MODE_TRUE = NightMode.TRUE.name
    val IVALUE_NIGHT_MODE_FALSE = NightMode.FALSE.name
    val IVALUE_NIGHT_MODE_SYSTEM = NightMode.SYSTEM.name
    ...
    const val KEY_BACKGROUND_OVERLAY_COLOR = "background-overlay-color" // Default: "background-overlay-color
    const val DEFAULT_IVALUE_BACKGROUND_OVERLAY_COLOR = 0x59000000

    /** Defines the set for keys loaded by termux
     * Setting this to `null` will make [SharedProperties] throw an exception.
     * */
