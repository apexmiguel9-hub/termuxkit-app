...
import com.termux.shared.termux.extrakeys.ExtraKeysView
    // Fixed: SpecialButton import
import com.termux.shared.termux.extrakeys.SpecialButton
import com.termux.terminal.TerminalSession
import com.termux.view.TerminalView

class TerminalExtraKeys(@NonNull val terminalView: TerminalView) : ExtraKeysView.IExtraKeysView {
    ...
    protected fun onTerminalExtraKeyButtonClick(
        view: View,
        key: String,
        ctrlDown: Boolean,
        altDown: Boolean,
        ...
        if (PRIMARY_KEY_CODES_FOR_STRINGS.containsKey(key)) {
            val keyCode = PRIMARY_KEY_CODES_FOR_STRINGS[key]
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ...
                val session = terminalView.getCurrentSession()
