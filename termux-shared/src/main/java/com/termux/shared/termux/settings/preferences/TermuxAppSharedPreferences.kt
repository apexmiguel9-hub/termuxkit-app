...
open class TermuxAppSharedPreferences protected constructor(
    ...
    companion object {
        ...
        @JvmStatic
        @Nullable
        fun build(@NonNull context: Context): TermuxAppSharedPreferences? {
            val termuxPackageContext = PackageUtils.getContextForPackage(context, TermuxConstants.TERMUX_PACKAGE_NAME)
            return if (termuxPackageContext == null)
                null
            else
                TermuxAppSharedPreferences(termuxPackageContext)
        }
         ...
         */
        @JvmStatic
        fun build(@NonNull context: Context, exitAppOnError: Boolean): TermuxAppSharedPreferences? {
    ...
    fun getFontSize(): Int {
        val fontSize = SharedPreferenceUtils.getInt(mSharedPreferences, TERMUX_APP.KEY_FONTSIZE, DEFAULT_FONTSIZE)
    ...
    fun setLogLevel(context: Context, logLevel: Int) {
        ...
        SharedPreferenceUtils.setInt(mSharedPreferences, TERMUX_APP.KEY_LOG_LEVEL, safeLogLevel, false)
    }
    ...
    fun setBackgroundImageEnabled(value: Boolean) {
