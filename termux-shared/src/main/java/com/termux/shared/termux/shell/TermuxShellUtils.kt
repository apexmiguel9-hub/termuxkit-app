...
object TermuxShellUtils {
    ...
    const val LOG_TAG = "TermuxShellUtils"
    ...
    fun clearTermuxTMPDIR(onlyIfExists: Boolean) {
        ...
        var days = 0 // properties.deleteTmpDirFilesOlderThanXDaysOnExit
        ...
        if (days < 0) {
            ...
            val error = FileUtils.clearDirectory("\$TMPDIR",
            ...
            val error = FileUtils.deleteFilesOlderThanXDays("\$TMPDIR",
                FileUtils.getCanonicalPath(TermuxConstants.TERMUX_TMP_PREFIX_DIR_PATH, null),
