...
open class AndroidShellEnvironment : UnixShellEnvironment() {
    ...
    @NonNull
    open override fun getEnvironment(@NonNull currentPackageContext: Context, isFailSafe: Boolean): HashMap<String, String> {
    ...
    @NonNull
    open override fun getDefaultWorkingDirectoryPath(): String = "/"

    @NonNull
    open override fun getDefaultBinPath(): String = "/system/bin"

    @NonNull
    override fun setupShellCommandEnvironment(@NonNull currentPackageContext: Context, @NonNull executionCommand: ExecutionCommand): HashMap<String, String> {
        ...
        environment[ENV_PWD] = if (workingDirectory != null && workingDirectory.isNotEmpty()) {
