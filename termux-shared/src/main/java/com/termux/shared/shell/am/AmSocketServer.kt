 ...
 */
class AmSocketServer private constructor() {
    ...
    companion object {
        ...
        @JvmStatic
        @Synchronized
        fun start(@NonNull context: Context, @NonNull localSocketRunConfig: LocalSocketRunConfig): LocalSocketManager? {
        ...
        @JvmStatic
        fun processAmClient(@NonNull localSocketManager: LocalSocketManager, @NonNull clientSocket: LocalClientSocket) {
            var error: Error?
            ...
            val amSocketServerRunConfig = localSocketManager.getLocalSocketRunConfig() as AmSocketServerRunConfig
        ...
        fun sendResultToClient(
            ...
            exitCode: Int,
            @Nullable stdout: String?,
            @Nullable stderr: String?
        ) {
         ...
         */
        @JvmStatic
        fun sanitizeExitCode(@NonNull clientSocket: LocalClientSocket, exitCode: Int): Int {
            return if (exitCode < 0 || exitCode > 255) {
                Logger.logWarn(
                    LOG_TAG,
        ...
        fun parseAmCommand(amCommandString: String?, amCommandList: MutableList<String>): Error? {
            ...
            return try {
                ...
                AmSocketServerErrno.ERRNO_PARSE_AM_COMMAND_FAILED_WITH_EXCEPTION.getError(e, amCommandString, e.message)
            }
        }
        ...
        fun runAmCommand(
            ...
            @NonNull stdout: StringBuilder,
            @NonNull stderr: StringBuilder,
            ...
            return try {
                ...
                AmSocketServerErrno.ERRNO_RUN_AM_COMMAND_FAILED_WITH_EXCEPTION.getError(
                    e,
                    amCommandArray.contentToString(),
                    e.message
                )
            }
        }
