...
abstract class UnixShellEnvironment : IShellEnvironment {
    ...
    @NonNull
    override abstract fun getEnvironment(@NonNull currentPackageContext: Context, isFailSafe: Boolean): HashMap<String, String>

    @NonNull
    override abstract fun getDefaultWorkingDirectoryPath(): String

    @NonNull
    override abstract fun getDefaultBinPath(): String

    @NonNull
    override fun setupShellCommandArguments(@NonNull executable: String, @Nullable arguments: Array<String>?): Array<String> {
        return ShellUtils.setupShellCommandArguments(executable, arguments)
    }

    @NonNull
    override abstract fun setupShellCommandEnvironment(@NonNull currentPackageContext: Context, @NonNull executionCommand: ExecutionCommand): HashMap<String, String>
}
