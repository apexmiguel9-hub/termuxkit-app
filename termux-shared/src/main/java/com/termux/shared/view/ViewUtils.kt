...
object ViewUtils {
    ...
    fun getWindowAndViewRects(view: View?, statusBarHeight: Int): Array<Rect>? {
        ...
        if (context is AppCompatActivity) {
            ...
            isInMultiWindowMode = android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N && context.isInMultiWindowMode
        ...
        var windowAvailableRect = Rect(windowRect.left, windowRect.top + actionBarHeight, windowRect.right, windowRect.bottom)
